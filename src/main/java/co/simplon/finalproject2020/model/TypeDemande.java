...
public class TypeDemande {
	...
	@Column(name = "NATURE")
	private NatureTypeDemande nature;
	...
	public TypeDemande(NatureTypeDemande nature, String libelle, String code, int echeance) {
		this.nature = nature;
	...
	public NatureTypeDemande getNature() {
		return nature;
	}
	public void setNature(NatureTypeDemande nature) {
		this.nature = nature;
	}
